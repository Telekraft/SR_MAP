...
$(window).on('load',function(){
    ...
    popup_A1 = L.popup({autoClose:false, closeOnClick:false,closeButton:false}).setContent('<a href="javascript:void(0);" class="A" rel="A4">Distance terminal</a>');
    popup_A2 = L.popup({autoClose:false, closeOnClick:false,closeButton:false}).setContent('<a href="javascript:void(0);" class="A" rel="A2">Densité</a>');
    popup_A3 = L.popup({autoClose:false, closeOnClick:false,closeButton:false}).setContent('<a href="javascript:void(0);" class="A" rel="A3">Sortie</a>');
    popup_A4 = L.popup({autoClose:false, closeOnClick:false,closeButton:false}).setContent('<a href="javascript:void(0);" class="A" rel="A5">Bus</a>');
    popup_A5 = L.popup({autoClose:false, closeOnClick:false,closeButton:false}).setContent('<a href="javascript:void(0);" class="A" rel="A5">Bus</a>');
    popup_A6 = L.popup({autoClose:false, closeOnClick:false,closeButton:false}).setContent('<a href="javascript:void(0);" class="A" rel="A5">Bus</a>');
    popup_A7 = L.popup({autoClose:false, closeOnClick:false,closeButton:false}).setContent('<a href="javascript:void(0);" class="A" rel="A3">Entrée</a>');
    popup_A8 = L.popup({autoClose:false, closeOnClick:false,closeButton:false}).setContent('<a href="javascript:void(0);" class="A" rel="A5">Bus</a>');
    popup_A9 = L.popup({autoClose:false, closeOnClick:false,closeButton:false}).setContent('<a href="javascript:void(0);" class="A" rel="A3">Sortie</a>');
    ...
    popup_B1 = L.popup({autoClose:false, closeOnClick:false,closeButton:false}).setContent('<a href="javascript:void(0);" class="B" rel="A4">Distance terminal</a>');
    popup_B2 = L.popup({autoClose:false, closeOnClick:false,closeButton:false}).setContent('<a href="javascript:void(0);" class="B" rel="A2">Densité</a>');
    ...
    popup_B4 = L.popup({autoClose:false, closeOnClick:false,closeButton:false}).setContent('<a href="javascript:void(0);" class="B" rel="A6">Boxes</a>');
    popup_B5 = L.popup({autoClose:false, closeOnClick:false,closeButton:false}).setContent('<a href="javascript:void(0);" class="B" rel="A5">Bus</a>');
    ...
    $('#map_toggle').click(function(){
        ...
        if($(this).attr('rel') == "MAP2"){
            ...
            displayA();
            $(this).attr('rel','MAP1');
            $('#logo h2').html('8 000 places <br /> 4 shuttle bus stops');
        }else{
    ...
    $('.close_ a').click(function(){
        console.log('close .description_zone');
